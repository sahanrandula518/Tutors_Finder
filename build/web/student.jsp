<%-- 
    Document   : student
    Created on : May 4, 2020, 7:53:06 PM
    ...
    <body onload="load()">
                                        ...
                                        <form id="form">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input id="student_id" type="hidden" class="form-control" value="0" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Phone</label>
                                                        <input id="phone" type="text" onkeypress="onClickValidationContactNumber()" class="form-control" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Dob</label>
                                                        <input id="dob" type="date" class="form-control" placeholder="Dob" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="update ml-auto mr-auto">
                                                    <button onclick="save()" type="button" class="btn btn-success btn-round">Save Student</button>
                                                    <button onclick="update()" type="button" class="btn btn-success btn-round">Update Student</button>
                                                    <button onclick="delet()" type="button" class="btn btn-success btn-round">Delete Student</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        <script>
            ...
            function selectedRowToInput() {
                ...
                for (var i = 1; i < table.rows.length; i++) {
                    table.rows[i].onclick = function () {
                        ...
                        document.getElementById("student_id").value = this.cells[1].textContent;
                        ...
                        document.getElementById("dob").value = this.cells[6].textContent;
                        document.getElementById("grade").value = this.cells[7].textContent;
                    };
                }
            }
            ...
            function save() {
                ...
                var grade = $('#grade').val();
                var action = "insert";
                if (student_id === "" || name === "" || address === "" || email === "" || phone === "" || dob === "" || grade === "") {
                    ...
                    $.ajax({
                        url: 'StudentServlet',
                        method: 'POST',
                        data: {action: action, student_id: student_id, name: name, address: address, email: email, phone: phone, dob: dob, grade: grade},
            ...
            function update() {
                ...
                } else if (student_id === "" || name === "" || address === "" || email === "" || phone === "" || dob === "" || grade === "") {
                    alert("Please Enter All Details")
